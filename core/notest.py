...
async def pruduct_test(delete: bool = True):
    ...
    size_1 = "huge"
    url_1 = "Ima URL"
    id_1 = await create_product(name_1, size_1, url_1)
    id_2 = await create_product(name_1, size_1, url_1)
    assert (id_1 == id_2)
    id = await get_product_id_by_parameters(name_1, size_1, url_1)
    assert (id == id_1)
    ...
    await update_product_by_id(id, name_2, size_2, url_2)
